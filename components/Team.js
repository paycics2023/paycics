  ...
  return (
    <div className="background-black" style={{ minHeight: "70vh" }}>
      <div className="container">
        ...
        <div className="row">
        <p>
              The first payment portal solution designed for the College of Information Computing Sciences (CICS)
              that enables seamless transactions within the organization through the utilization of blockchain technology and non-fungible token (NFTs).
            </p>
